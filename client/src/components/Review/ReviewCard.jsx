...
export default function ReviewCard({
  ...
  return (
    <div className="text-[100%] w-[500px] max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
      <div className="p-[20px] flex flex-col gap-[5px]">
        <div className="flex justify-between items-center ">
          <h2 className="text-[100%] font-bold text-gray-800">
            {reviewerName}
          </h2>
          {date && (
        ...
        <p className="text-gray-600 text-[85%] leading-relaxed">
          {description}
        </p>
      </div>
    </div>
